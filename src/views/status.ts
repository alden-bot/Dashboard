...
export function renderStatus(
	...
	const memPercent = Math.round((1 - status.os.freeMem / status.os.totalMem) * 100);
	...
	const content = `
		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
			...
			<div class="bg-gray-900 border border-gray-800 rounded-xl p-5">
				<h3 class="text-sm font-medium text-gray-400 mb-4">System Memory</h3>
				<div class="flex justify-between text-sm mb-2">
					<span class="text-gray-500">${status.os.freeMem} MB free</span>
				...
				<div class="text-right text-xs text-gray-500">${memPercent}% used</div>
			</div>
		</div>
